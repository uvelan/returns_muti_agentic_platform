...
GIVEN_NAMES = (
    "ALEX", "JORDAN", "SAM", "RILEY", "CASEY", "AVERY", "TAYLOR", "QUINN",
    "MORGAN", "DREW", "HAYDEN", "ROWAN", "SKYLER", "EMERSON", "PARKER", "REESE",
    "DAKOTA", "LOGAN", "CAMERON", "ELLIS", "FINLEY", "HARPER", "JAMIE", "KENDALL",
)
SURNAMES = (
    "MORGAN", "REYES", "OKONKWO", "CHEN", "NDIAYE", "LINDQVIST", "MBEKI",
    "DELACROIX", "HALVORSEN", "ADEYEMI", "KOWALSKI", "NAKAMURA", "OSEI",
    "PETROV", "RAMIREZ", "SOLBERG", "TANAKA", "VARGAS", "WHITFIELD", "ZHAO",
)
...
BUSINESS_NAMES = (
    "MERIDIAN HEATING & COOLING", "NORTHGATE PLUMBING SUPPLY", "BRIGHTWATER MECHANICAL",
    "CEDAR RIDGE HVAC", "STONEBRIDGE PIPEWORKS", "HARBOR POINT SERVICES",
    "IRONGATE CONTRACTORS", "SILVERLAKE AIR SYSTEMS", "WESTFIELD PLUMBING CO",
    "GRANITE PEAK MECHANICAL", "BLUEFIN UTILITIES", "OAKMONT CLIMATE CONTROL",
    "REDSTONE INDUSTRIAL", "CLEARBROOK SUPPLY", "FAIRVIEW HEATING",
)

PRODUCT_NAMES = (
    "3/4 IN COPPER 90 ELBOW", "1/2 IN PEX BALL VALVE", "40 GAL GAS WATER HEATER",
    "3 TON CONDENSING UNIT", "20X25X1 PLEATED AIR FILTER", "1 IN BRASS GATE VALVE",
    "4 IN PVC SEWER PIPE", "3/4 HP SUMP PUMP", "24 IN FLEXIBLE DUCT",
...
ORGANISATION_KEYS = (
    "custname", "customername", "shiptoname", "billtoname", "vendorname",
    "companyname", "accountname", "maincustsname", "partyname",

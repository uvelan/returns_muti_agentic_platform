      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            onClick={onRefresh}
            disabled={refreshing}
            className="inline-flex items-center gap-2 rounded-lg border border-emerald-800 px-3 py-2 text-sm text-emerald-200 disabled:opacity-40"
          >
            <RefreshCw size={14} />
        ...
        <div className="flex items-center gap-2">
          ...
          {showingData ? (
            <button
              ...
              className="inline-flex items-center gap-2 rounded-lg border border-emerald-800 px-3 py-2 text-sm text-emerald-200"
            >
              <FileKey size={14} />
              View schema
            </button>

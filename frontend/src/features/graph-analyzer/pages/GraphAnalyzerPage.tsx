            ...
            <section className="rounded-xl border border-emerald-950 bg-[#0a1714] p-4">
              <div className="mb-4 flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-slate-500">Select analysis scope</p>
                </div>

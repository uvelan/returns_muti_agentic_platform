...
export function ReturnCopilotPage() {
  ...
  //
  // The counter lives in `useElapsedSeconds` now, because three other screens
  // needed the same thing and this was the only place that had got it right.
  const waitingSeconds = useElapsedSeconds(send.isPending);

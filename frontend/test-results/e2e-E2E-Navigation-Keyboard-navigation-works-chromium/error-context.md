...
- Name: e2e.spec.ts >> E2E Navigation >> Keyboard navigation works
- Location: tests\e2e.spec.ts:53:3
...
Locator: locator('a[aria-label="Return Platform overview"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('a[aria-label="Return Platform overview"]')
